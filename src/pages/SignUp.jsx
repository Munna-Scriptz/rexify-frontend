...
const SignUp = () => {
    return (
        <div className="min-h-screen flex items-center justify-center bg-white font-sans">
            <div className="w-full max-w-[700px] px-6 py-12 flex flex-col items-center">
                ...
                <div className="w-full flex items-start justify-between mb-10">
                    ...
                    {/* Line Spacer 1 */}
                    <div className="flex-1 h-[1px] bg-text-muted mt-3 mx-2"></div>

                    {/* Step 2 (Perfectly Centered) */}
                    <div className="flex flex-col items-center w-fit">
                ...
                {/* 4. Next Button */}
                <button className="w-full bg-[#C4C4C4] text-white font-semibold py-3.5 rounded-full mb-10 hover:bg-text-primary transition-colors duration-300 cursor-pointer">
                    Next
                </button>
